...
class GetSearchArtistUseCase implements UseCase<PersonEntity,ArtistSearchParams > {
  ...
  @override
  Future<Either<Failure, PersonEntity>> call(ArtistSearchParams params) async{
